...
public class ProvinciaResourceIT {
     ...
     *
     * @see com.mynegocio.app.repository.search.ProvinciaSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProvincia() throws Exception {
        ...
        verify(mockProvinciaSearchRepository, times(1)).save(testProvincia);
    }
    ...
    public void createProvinciaWithExistingId() throws Exception {
        ...
        // Validate the Provincia in Elasticsearch
        verify(mockProvinciaSearchRepository, times(0)).save(provincia);
    }
    ...
    public void updateProvincia() throws Exception {
        ...
        reset(mockProvinciaSearchRepository);
    ...
    public void deleteProvincia() throws Exception {
        ...
        // Validate the Provincia in Elasticsearch
        verify(mockProvinciaSearchRepository, times(1)).deleteById(provincia.getId());
    }
    ...
    public void searchProvincia() throws Exception {
        // Initialize the database
        provinciaService.save(provincia);
        when(mockProvinciaSearchRepository.search(queryStringQuery("id:" + provincia.getId())))
            .thenReturn(Collections.singletonList(provincia));
