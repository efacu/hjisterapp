...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('hjisterapp1App.department.home.title');
  });
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('hjisterapp1App.department.home.createOrEditLabel');
  ...
  it('should create and save Departments', async () => {
    ...
    await departmentComponentsPage.clickOnCreateButton();
    await promise.all([departmentUpdatePage.setDepartmentNameInput('departmentName')]);
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('hjisterapp1App.department.delete.question');
