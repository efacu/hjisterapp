...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    ...
    expect(await employeeComponentsPage.getTitle()).to.eq('hjisterapp1App.employee.home.title');
  });
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('hjisterapp1App.employee.home.createOrEditLabel');
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('hjisterapp1App.employee.delete.question');
