...
describe('Country e2e test', () => {
  ...
  it('should load Countries', async () => {
    ...
    expect(await countryComponentsPage.getTitle()).to.eq('hjisterapp1App.country.home.title');
  });
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle()).to.eq('hjisterapp1App.country.home.createOrEditLabel');
  ...
  it('should create and save Countries', async () => {
    ...
    await countryComponentsPage.clickOnCreateButton();
    await promise.all([countryUpdatePage.setCountryNameInput('countryName')]);
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle()).to.eq('hjisterapp1App.country.delete.question');
