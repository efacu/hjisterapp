...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('hjisterapp1App.jobHistory.home.title');
  });
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('hjisterapp1App.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('hjisterapp1App.jobHistory.delete.question');
